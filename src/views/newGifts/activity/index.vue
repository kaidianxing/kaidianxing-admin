...
export default {
    ...
    methods: {
        ...
        getNewGiftsList() {
            ...
            this.$api.newGiftsApi.getNewGiftsList(params).then((res) => {
                this.loading = false
                if (res.error === 0) {
                    this.data = res.list
        ...
        handleStop(id) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.stopNewGiftsActivity(id)
                },
                onCancel: () => {},
            })
        },
        // 停止活动
        stopNewGiftsActivity(id) {
        ...
        handleDelete(id) {
            this.$Modal.confirm({
                ...
                content: '确定要删除该活动？',
                onOk: () => {
                    this.deleteNewGiftsActivity(id)
                },
                onCancel: () => {},
            })
        },
        // 删除活动
        deleteNewGiftsActivity(id) {
            this.$api.newGiftsApi
