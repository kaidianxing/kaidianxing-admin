                ...
                <template slot-scope="{ row }" slot="reward">
                    <div class="reward" v-if="row.reward">
                        <div
                            ...
                            v-if="row.reward.coupon_title && row.reward.coupon_title.length"
                        >
                            <div
                        ...
                        <div class="reward-balance mb" v-if="row.reward.balance">
...
export default {
    ...
    methods: {
        ...
        getShoppingRewardLog() {
            ...
            this.$api.shoppingRewardApi.getShoppingRewardLog(params).then((res) => {
                this.loading = false
                if (res.error === 0) {
                    this.data = res.list
