...
<template>
    <div class='condition-consumption'>
        <FormItem label="消费条件：" :label-width='120' prop="become_order_count">
            <kdx-rr-input number :fixed="0" :min-value="1" :max-value="999999999" :disabled='noManagePerm' v-model="settings.become_order_count" style='width:250px;'>
