...
<template>
    <div class="multi-select">
        ...
        <RadioGroup v-model="type" @input="handleInput">
            <Radio label="0" border :disabled="!!$route.query.id">
                <div class="tit">实体商品</div>
                <div class="desc">物流发货</div>
                <kdx-svg-icon type="icon-yes1" class="icon"></kdx-svg-icon>
            </Radio>
            <Radio label="1" border :disabled="!!$route.query.id">
                <div class="tit">虚拟商品</div>
                <div class="desc">无需物流</div>
                <kdx-svg-icon type="icon-yes1" class="icon"></kdx-svg-icon>
            </Radio>
            <Radio label="2" border :disabled="!!$route.query.id || flag == '2' || flag == '3' " v-if="flag != '0' || !!$route.query.id">
