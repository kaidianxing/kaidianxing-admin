 ...
 */
<template>
    <div class='poster_price' v-if='currentModal.id=="poster_sellprice"&&lazyLoad'>
        <i-form :label-width="100" ref='pictures' :model="currentModal" :rules="validator">
            <MyCollapse no-border>
                <p class="form-title" slot='label'>
                    内容样式
                </p>
                <form-item label="商品售卖价：" style='margin-bottom:10px;'>
                    <Input placeholder="请输入商品售卖价" v-model='currentModal.params.content' style="width: 160px;">
                    </Input>
