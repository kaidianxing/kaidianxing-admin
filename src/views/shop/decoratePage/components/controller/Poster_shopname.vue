 ...
 */
<template>
    <div class='poster_shopname' v-if='currentModal.id=="poster_shopname"&&lazyLoad'>
           <i-form :label-width="100" ref='pictures' :model="currentModal" :rules="validator">
            <MyCollapse no-border>
                ...
                <form-item label="昵称：" style='margin-bottom:10px;'>
                    <p style='padding-top:3px;'>{{currentModal.params.content}}</p>
                    <Alert style='margin-top:10px;'>提示：此数据只作为展示使用，真实数据以获取的店铺名称为准。</Alert>
                </form-item>
