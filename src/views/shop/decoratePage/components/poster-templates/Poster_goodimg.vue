 ...
 */
<template>
    <img class='img poster_goodimg' :src="getUrl" :style='getStyle' alt="" @error="loaded" @load="loaded">
</template>
    ...
    export default {
        ...
        computed: {
            ...
            getUrl() {
                ...
                return this.$utils.staticImg('decorate/default_goods3.jpg')
            }
        },
        methods: {
            loaded(){
                this.$emit('custom-event', {
                    target: 'poster_goodimg/loaded',
                }) 
            }
        },
        mounted() {
            this.$emit('custom-event', {
                target: 'poster_goodimg/loading',
            }) 
        },
    }
</script>
