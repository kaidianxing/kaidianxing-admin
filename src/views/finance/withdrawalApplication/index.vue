                ...
                <div class="tbody" v-if="list.length">
                    ...
                    >
                        ...
                        <ul>
                                ...
                                <div class="box">
                                    ...
                                    <div class="right">
                                        ...
                                        <div class="icon">
                                            ...
                                            <span style="color:#12aa9c;font-size:16px" class="iconfont icon-PCduan" v-else-if="item.source === '70'"></span>
                                            <!-- <span
                            ...
                            <li>
                                <div class="box" v-if="item.status !== '10' && item.status !== '11' && item.status !== '40'">
                                    <Button
                                        :disabled='noManagePerm'
                                        type="text"
                                        @click="handleWithdraw(item)"
                                    >
                                        {{ item.pay_type === '20' ? '微信打款' : '支付宝打款'}}
                                    </Button>
                                    <Button
                                        :disabled='noManagePerm'
                                        class="mL-10"
...
export default {
    ...
    methods: {
        ...
        getWithdrawList() {
            ...
            this.$api.financeApi.getWithdrawList(_params).then((res) => {
                this.loading = false;
                if (res.error == 0) {
        ...
        handleExport() {
            ...
            // let downloadurl = `${base_url}manage/finance/log/withdraw&level_id=${level_id}&status=${status}&pay_type=${pay_type}&keyword=${keyword}&page=${page}&pagesize=${pagesize}&export=1`
            if (this.searchData.startTime) {
            ...
            Export('manage/finance/log/withdraw', params);
