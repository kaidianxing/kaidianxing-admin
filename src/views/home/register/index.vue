                            ...
                            <form-item label="强制授权登录：">
                                ...
                                >系统默认关闭强制授权登录，当触发加入购物车、立即购买、提交表单、领取优惠券时需要获取用户用户登录信息。
                                    <kdx-hint-tooltip
                                        type="image"
                                        :image="
                                        require('@/assets/image/home/get-info.png')
                                    "
                                    ></kdx-hint-tooltip>
                                </kdx-hint-text>
                                <kdx-hint-text
                                >开启强制授权登录时，用户访问商城必须授权后才可进行商城浏览及下单操作。
                                    <kdx-hint-tooltip
                                        type="image"
                                        :image="
                                        require('@/assets/image/home/force-login.png')
                                    "
                                    ></kdx-hint-tooltip>
                                </kdx-hint-text>
                                <div
                                ...
                                <RadioGroup v-model="model.h5_login_method">
                                    ...
                                    >短信验证码登录
                                        <kdx-hint-tooltip
                                            type="image"
                                            :image="
                                            require('@/assets/image/home/login-code.png')
                                        "
                                        ></kdx-hint-tooltip>
                                        >
                                    </Radio>
                                    ...
                                    >账号密码登录
                                        <kdx-hint-tooltip
                                            type="image"
                                            :image="
                                            require('@/assets/image/home/login-pass.png')
                                        "
                                        ></kdx-hint-tooltip>
                                        >
                                    </Radio>
                            ...
                            <div class="inventory-settings">
                                ...
                                <kdx-hint-text>
                                    ...
                                    <kdx-hint-tooltip
                                        type="image"
                                        :image="
                                            require('@/assets/image/home/bind_mobile.png')
                                        "
                                    ></kdx-hint-tooltip>
                                </kdx-hint-text>
                                <div class="nest-box">
                            ...
                            <div class="inventory-settings">
                                ...
                                <kdx-hint-text>
                                    ...
                                    <kdx-hint-tooltip
                                        type="image"
                                        :image="
                                            require('@/assets/image/home/bind_mobile_btn.png')
                                        "
                                    ></kdx-hint-tooltip>
                                </kdx-hint-text>
                            </div>
