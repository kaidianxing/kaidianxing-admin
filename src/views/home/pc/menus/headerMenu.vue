...
<template>
    <div class="good-label">
        <kdx-header-bar type="little">
            <template #header>
                <Button type="primary" :disabled='noManagePerm' @click='toAdd'>创建顶部菜单</Button>
            </template>
            <br>
        ...
        <div class="table-list" v-loading="table.loading">
            <table-list ref="table_list" :data="getTableData" type="1" :total="table.total" @on-refresh="getList"
