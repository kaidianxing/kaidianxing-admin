    ...
    <div class='diyform'>
        ...
        <div class="form-templates form-templates-pictures" v-if='model.id=="pictures"'>
            ...
            <div class="templates-box templates-img">
                <form-pictures :model="formData" @on-change="changePictures"></form-pictures>
            </div>
        </div>
        <!-- singlelinetext -->
            ...
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <input :value="formData.params.value" type="text" :maxlength="-1" :placeholder="formData.params.tip" @blur="blurInput" class="item-input" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-templates" v-else-if='model.id=="multilinetext"'>
            <div class="templates-box">
                <div class="templates-item flex-column">
                    ...
                    <div class="item-content">
                        <textarea :value="!$isPC ? formData.params.value : ''" type="text" :maxlength="-1" auto-height :placeholder="formData.params.tip" @blur="blurInput" class="item-input item-input-textarea" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-templates" v-else-if='model.id=="selector"'>
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <form-select class="flex1" :model="formData" @on-change="changeSelect"></form-select>
                        <div class="item-icon">
        ...
        <div class="form-templates" v-else-if='model.id=="radios"'>
            ...
            <div class="templates-box">
                <m-radios :value="$isPC ? value : formData.params.value" :data="formData.data" @on-change="changeRadios"></m-radios>
            </div>
        </div>
        <!-- checkboxes -->
        <div class="form-templates" v-else-if='model.id=="checkboxes"'>
            ...
            <div class="templates-box">
                <m-checked :value="$isPC? value : formData.params.value" :data="formData.data" @on-change="changeCheckbox"></m-checked>
            </div>
        </div>
        <!-- city -->
        <div class="form-templates" v-else-if='model.id=="city"'>
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <form-city ref="form_city" class="flex1" :model="formData" @on-change="changeCity"></form-city>
                        <div class="item-icon">
                            <i class="icon-m-down iconfont-m-"></i>
                        </div>
                    </div>
        ...
        <div class="form-templates" v-else-if='model.id=="datepicker"'>
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <form-date :model="formData.params" class="flex1" @on-change="changeDate"></form-date>
                        <div class="item-icon">
            ...
            <div class="templates-box flex-column template-date-range">
                <div class="templates-item-box">
                    <div class="templates-item flex">
                        <form-date :model="formData.params.start" class="flex1" @on-change="changeStart"></form-date>
                        <div class="item-icon">
                            <i class="icon-m-riqi iconfont-m-"></i>
                        </div>
                    </div>
                ...
                <div class="templates-item-box">
                    <div class="templates-item flex">
                        <form-date :model="formData.params.end" class="flex1" @on-change="changeEnd"></form-date>
                        <div class="item-icon">
                            <i class="icon-m-riqi iconfont-m-"></i>
                        </div>
                    </div>
        ...
        <div class="form-templates" v-else-if='model.id=="identity"'>
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <input :value="!$isPC ? formData.params.value: ''" type="text" :placeholder="formData.params.tip" class="item-input" @blur="blurInput" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-templates" v-else-if='model.id=="timer"'>
            <div class="templates-box">
                <div class="templates-item">
                    ...
                    <div class="item-content">
                        <form-time :model="formData.params" @on-change="changeTime" class="flex1"></form-time>
                        <div class="item-icon">
        ...
        <div class="form-templates" v-else-if='model.id=="timerange"'>
            ...
            <div class="templates-box flex-column template-date-range">
                <div class="templates-item-box">
                    <div class="templates-item flex">
                        <form-time :model="formData.params.start" class="flex1" @on-change="changeStart"></form-time>
                        <div class="item-icon">
                            <i class="icon-m-shijian1 iconfont-m-"></i>
                        </div>
                    </div>
                ...
                <div class="templates-item-box">
                    <div class="templates-item flex">
                        <form-time :model="formData.params.end" class="flex1" @on-change="changeEnd"></form-time>
                        <div class="item-icon">
                            <i class="icon-m-shijian1 iconfont-m-"></i>
                        </div>
                    </div>
