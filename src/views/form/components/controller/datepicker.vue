...
<template>
    <div class="controller-item">
        ...
        <div class="input-middle-box flex-column input-middle-datepicker">
            ...
            <div class="input-middle-item date-pick">
                <div class="middle-item-item flex">
                    <div class="label">
                        默认：
                    </div>
                    <div class="content">
                ...
                <div class="middle-item-item" v-if="model.params.status === 1">
                    <DatePicker :value="model.params.value" type="date" placeholder="请选择指定日期" @on-change="changeDate"></DatePicker>
                </div>
            </div>
        </div>
