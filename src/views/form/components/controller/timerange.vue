                ...
                <div class="input-middle-item input-daterange-data">
                    ...
                    <div class="input-middle-item flex-column">
                        ...
                        <div class="middle-item-item" v-if="model.params.start.status === 1">
                            <TimePicker :value="model.params.start.value" type="time" placeholder="请选择指定时间" @on-change="changeStart"></TimePicker>
                        </div>
                    </div>
                </div>
                <div class="input-middle-item align-end">
                ...
                <div class="input-middle-item input-daterange-data">
                    ...
                    <div class="input-middle-item flex-column">
                        ...
                        <div class="middle-item-item" v-if="model.params.end.status === 1">
                            <TimePicker :value="model.params.end.value" type="time" placeholder="请选择指定时间" @on-change="changeEnd"></TimePicker>
                        </div>
                    </div>
                </div>
                <div class="input-middle-item align-end">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeStart(time) {
                this.model.params.start.value = time;
            },
            changeEnd(time) {
                this.model.params.end.value = time;
            }
        }
