    ...
    <div>
        ...
        >
                ...
                <div class="main-content">
                    <div class="step">
                        <div
                                ...
                                :key="index"
                        >
                            <div class="step-item-circle">{{ index + 1 }}</div>
                            <div class="step-item-text">{{ step }}</div>
                            <img
                                    v-if="index < 3"
                                    :src="
                                    require('@/assets/image/decorate/arrow-right.png')
                                "
                                    class="arrow-right"
                            />
                        </div>
            ...
            <template v-slot:footer>
                <div>
                    <Button class="default-long" @click="saveHot">保存</Button>
                    <Button class="primary-long" @click="addHot"
                    >添加热区</Button
                    >
                </div>
            </template>
        ...
        methods: {
            ...
            saveHot() {
                ...
                this.lists.forEach((v, index) => {
                    if (!v.linkurl) {
                        this.$set(this.lists[index], "error", true);
                        errFlag = true;
                    }
                });
                if (errFlag) {
            ...
            addHot() {
                ...
                let top = Math.max(scrollTop-60,10)
