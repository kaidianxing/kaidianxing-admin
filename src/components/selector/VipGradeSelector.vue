 ...
 */
<template>
    <kdx-modal-frame v-model="value" title="会员等级选择器" :width="850" @on-ok="handleOk" @on-cancel="handleCancel">
        <div class="vip-grade-selector">
            <div class="vip-grade-selector-content" ref='scrollBox'>
                <div class="search">
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                this.$api.memberApi.getLevelList(params).then(res => {
                    if (res.error === 0) {
                        this.data = res.list;
