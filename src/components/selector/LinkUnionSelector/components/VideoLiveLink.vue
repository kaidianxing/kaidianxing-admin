    ...
    <div class="app-content">
        <Form ref="form" :label-width="120" :rules="rules" :model="model" class="app-form">
            ...
            <kdx-hint-text style="margin-top: -20px;" class="marginL-120">
                <span>请登录</span><Button type="text" to="https://channels.weixin.qq.com/platform/login" target="_blank">视频号助手</Button><span>获取视频号ID</span>
...
export default {
    ...
    methods: {
        blurHandler() {
            let { video_number_id } = this.model;
