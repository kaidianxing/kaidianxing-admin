    ...
    >
        <div class="goods-preview">
            <div class="goods-preview-content" ref='scrollBox'>
                ...
                <Table v-if="!activity.show" ref="table" :columns="columns" :data="table.data" v-loading="table.loading"></Table>
...
export default {
    ...
    props: {
        ...
        is_shopping_reward: { //购物奖励独有的处理参数
            type: [Number],
            default: 0
        },
    },
                        ...
                        return (
                            <div class="action">
                                <Button class="default-primary"
                                        disabled={params.row.is_select === 1}
    ...
    created() {
        ...
        * 处理单店铺活动查看不显示活动来源列
        * */
            this.activity.columns = this.activity.columns.filter(col => col.key !== 'sub_shop_id')
    },
    methods: {
        handleSearch() {
            this.resetPage()
