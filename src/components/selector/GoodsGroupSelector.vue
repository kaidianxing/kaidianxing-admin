 ...
 */
<template>
    <kdx-modal-frame v-model="value" title="商品组选择器" :width="850" @on-ok="handleOk" @on-cancel="handleCancel">
        <div class="goods-group-selector">
            <div class="goods-group-content" ref='scrollBox'>
                <div class="search">
